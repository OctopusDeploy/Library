...
export default class TwitterButton extends React.Component {
  ...
  renderWidget() {
    ...
    window.twttr.widgets.createShareButton(this.props.url, this._twitterButton, { text: text });
  }

  render() {
    return <a className="twitter-share-button" data-via="library-octopusdeploy" href="https://twitter.com/share" ref={(btn) => (this._twitterButton = btn)} />;
  }
}
